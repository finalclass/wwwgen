package cms {
  ...
  public class Model extends EventDispatcher {
    ...
    [Bindable] static public var TYPES:ArrayCollection = new ArrayCollection([
    ...
    public static function set content(value:XML) : void {
      Model._content = value;
      Model.getInstance().dispatchEvent(new Event(Model.CONTENT_CHANGED));
    }
